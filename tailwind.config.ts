  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Refined stone and cream palette
        "warm-stone": "var(--warm-stone)",
        "medium-stone": "var(--medium-stone)",
        "dark-stone": "var(--dark-stone)",
        "light-cream": "var(--light-cream)",
        "pure-cream": "var(--pure-cream)",
        "soft-taupe": "var(--soft-taupe)",
        "emergency-red": "var(--emergency-red)",
        "emergency-green": "var(--emergency-green)",
        "emergency-yellow": "var(--emergency-yellow)",
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
